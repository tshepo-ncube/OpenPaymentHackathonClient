...
import OneTimePayments from "../../../api/OneTimePayments";
import RecurringPayments from "../../../api/RecurringPayments";
const StudentPage = ({ params }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    OneTimePayments.startOneTimePayment(
      senderWalletUrl,
      contribution,
      studentURL,
      studentID,
  ...
  const finishPayment = async (interactRefParam) => {
    console.log("mooooving to fiinish.......................");
    OneTimePayments.finishOneTimePayment(interactRefParam, senderWalletUrl);
    // const data = {
          ...
          <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="md:flex">
              ...
              <div className="p-8">
                ...
                <div className="flex mt-4 rounded shadow-lg p-2">
                  <button className="flex-1 text-xl  bg-white text-gray-800 font-semibold py-2 px-4 rounded inline-flex items-center">
                  ...
                  <div className="ml-2  flex space-x-2">
                    ...
                    <a href="#" className="p-2 text-blue-300">
                      <FaTwitter size={24} />
                    </a>
                    <a href="#" className="p-2 text-blue-600">
                      <FaLinkedin size={24} />
                    </a>
                    <a href="#" className="p-2 text-green-500">
                      <FaWhatsapp size={24} />
                    </a>
                  </div>
                </div>
